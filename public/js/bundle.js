...
exports.hideAlerts = exports.showAlert = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return _axios.default.post('http://localhost:3000/update-user', {
              email: email,
              name: name
            });
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _axios.default.patch('http://localhost:3000/api/v1/users/update-password', data);
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZHJldzg3IiwiYSI6ImNrcHNwMjg2aTBnN3kyb282dXFhamZvcWgifQ.3hYxNan-zSc5UFL7iOpIZw';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day: ".concat(loc.day, ": ").concat(loc.description, "<p/>")).addTo(map); //extend bounds
...
if (updatePasswordForm) {
  ...
  function () {
    ...
    regeneratorRuntime.mark(function _callee(e) {
      var savePasswordButton, currentPassword, password, passwordConfirm;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
